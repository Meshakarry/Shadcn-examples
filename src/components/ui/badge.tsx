...
const badgeVariants = cva(
  "cursor-pointer inline-flex items-center rounded-full px-2 py-1 text-xs rounded-lg transition-colors focus:outline-none focus:ring-3 focus:ring-primary-200",
  {
    variants: {
      variant: {
        default:
